...
// 1. Komponen Utama Form Register (Logika & Tampilan Asli Kamu)
function RegisterFormContent() {
  const searchParams = useSearchParams();
  const roleParam = searchParams.get("role") || "seafarer";
...
// 2. Export Halaman Utama Menggunakan Suspense Boundary (Penyelesai Error Vercel)
export default function RegisterPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen flex items-center justify-center">
          <p className="text-gray-500">Memuat halaman pendaftaran...</p>
        </div>
      }
    >
      <RegisterFormContent />
